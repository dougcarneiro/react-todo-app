...
export default function RemoveModal({todo}) {
    ...
    return (
        ...
        <Modal
            open={open}
            className="fixed w-full mx-auto first-line:bg-white font-montserrat z-[60] overflow-x-hidden overflow-y-auto"
                ...
                >
                    <div className="transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                        ...
                        <div className="flex justify-between items-center py-3 px-4 border-b ">
                            <h3 className="font-satisfy text-xl font-bold text-violet-800">
                            Remover Afazer
                            </h3>
                            <button
                            type="button"
                        ...
                        <div className="p-4 overflow-y-auto">
                            ...
                            Deseja remover o afazer <span className="font-semibold">{todo.title}</span>?
                            </p>
                        </div>
